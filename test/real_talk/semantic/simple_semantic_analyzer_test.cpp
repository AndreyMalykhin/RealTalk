...
TEST_F(SimpleSemanticAnalyzerTest,
  ...
  for (TestData &test_data: test_data_suits) {
    ...
    unique_ptr<SemanticProblem> problem(new DefWithUnsupportedTypeError(
        file_path, *var_def_node_ptr, var_data_type_ptr->Clone()));
    problems.push_back(move(problem));
...
TEST_F(SimpleSemanticAnalyzerTest,
  ...
  path program_file_path;
  unique_ptr<SemanticProblem> problem(new DefWithUnsupportedTypeError(
      program_file_path, *var_def_node_ptr, var_data_type_ptr->Clone()));
  problems.push_back(move(problem));
...
TEST_F(SimpleSemanticAnalyzerTest, ArgDefWithVoidDataTypeIsInvalid) {
  ...
  path program_file_path;
  unique_ptr<SemanticProblem> problem(new DefWithUnsupportedTypeError(
      program_file_path, *arg_def_node_ptr, arg_data_type_ptr->Clone()));
  problems.push_back(move(problem));
...
TEST_F(SimpleSemanticAnalyzerTest, IfElseIf) {
  ...
  {
    DataType *dest_data_type = &bool_data_type;
...
TEST_F(SimpleSemanticAnalyzerTest,
  ...
  FuncDataType *func_data_type_ptr = new FuncDataType(
      move(func_return_data_type), move(func_arg_data_types));
  unique_ptr<FuncDataType> func_data_type(func_data_type_ptr);
  ExprAnalysis id_expr_analysis(move(func_data_type));
  expr_analyzes.insert(make_pair(id_node_ptr, move(id_expr_analysis)));
  ...
  BoolDataType bool_data_type;
  DataType *dest_data_type = &bool_data_type;
  DataType *src_data_type = func_data_type_ptr;
  bool is_data_type_convertable = false;
  TestDataTypeConversion test_data_type_conversion =
      {dest_data_type, src_data_type, is_data_type_convertable};
  test_data_type_conversions.push_back(test_data_type_conversion);
...
TEST_F(SimpleSemanticAnalyzerTest,
  ...
  unique_ptr<DataType> var_data_type(var_data_type_ptr);
  ExprAnalysis id_expr_analysis1(move(var_data_type));
  ...
  FuncDataType *func_data_type_ptr = new FuncDataType(
      move(func_return_data_type), move(func_arg_data_types));
  unique_ptr<FuncDataType> func_data_type(func_data_type_ptr);
  ExprAnalysis id_expr_analysis2(move(func_data_type));
  ...
  {
    DataType *dest_data_type = &bool_data_type;
    DataType *src_data_type = var_data_type_ptr;
    bool is_data_type_convertable = true;
    TestDataTypeConversion test_data_type_conversion =
        {dest_data_type, src_data_type, is_data_type_convertable};
    test_data_type_conversions.push_back(test_data_type_conversion);
...
TEST_F(SimpleSemanticAnalyzerTest, Import) {
  ...
  unique_ptr<DataStorage> var_storage3(new GlobalDataStorage());
  unique_ptr<DefAnalysis> var_def_analysis3(
      new VarDefAnalysis(move(var_data_type3), move(var_storage3)));
  def_analyzes.insert(make_pair(var_def_node_ptr3, move(var_def_analysis3)));
  ...
  ExprAnalysis file_path_expr_analysis3(move(file_path_expr_data_type3));
  expr_analyzes.insert(
  ...
  ExprAnalysis file_path_expr_analysis4(move(file_path_expr_data_type4));
  expr_analyzes.insert(
  ...
  ExprAnalysis file_path_expr_analysis5(move(file_path_expr_data_type5));
  expr_analyzes.insert(
...
TEST_F(SimpleSemanticAnalyzerTest, PreTestLoop) {
  ...
  unique_ptr<DataStorage> var_storage1(new GlobalDataStorage());
  unique_ptr<DefAnalysis> var_def_analysis1(new VarDefAnalysis(
      move(var_def_data_type1), move(var_storage1)));
  def_analyzes.insert(make_pair(var_def_node_ptr1, move(var_def_analysis1)));
  unique_ptr<DataType> var_def_data_type2(new BoolDataType());
  unique_ptr<DataStorage> var_storage2(new LocalDataStorage());
  unique_ptr<DefAnalysis> var_def_analysis2(new VarDefAnalysis(
      move(var_def_data_type2), move(var_storage2)));
  def_analyzes.insert(make_pair(var_def_node_ptr2, move(var_def_analysis2)));
  ...
  BoolDataType bool_data_type;
  DataType *dest_data_type = &bool_data_type;
  DataType *src_data_type = id_data_type_ptr;
  bool is_data_type_convertable = true;
  TestDataTypeConversion test_data_type_conversion =
      {dest_data_type, src_data_type, is_data_type_convertable};
  test_data_type_conversions.push_back(test_data_type_conversion);
...
TEST_F(SimpleSemanticAnalyzerTest, LessWithIncompatibleTypeIsInvalid) {
  ...
  unique_ptr<SemanticProblem> problem(new BinaryExprWithIncompatibleTypeError(
      program_file_path,
      *less_node_ptr,
      lit_data_type_ptr1->Clone(),
      lit_data_type_ptr2->Clone()));
  problems.push_back(move(problem));
...
TEST_F(SimpleSemanticAnalyzerTest, LessWithUnsupportedTypesIsInvalid) {
  ...
  unique_ptr<SemanticProblem> problem(new BinaryExprWithUnsupportedTypesError(
      program_file_path,
      *less_node_ptr,
      id_data_type_ptr1->Clone(),
      id_data_type_ptr2->Clone()));
  problems.push_back(move(problem));
...
TEST_F(SimpleSemanticAnalyzerTest,
       ArrayAllocWithoutInitUsingIncompatibleSizeDataTypeIsInvalid) {
  vector< unique_ptr<StmtNode> > stmt_nodes;
  unique_ptr<PrimitiveDataTypeNode> data_type_node(new IntDataTypeNode(
      TokenInfo(Token::kIntType, "int", UINT32_C(1), UINT32_C(1))));
  vector< unique_ptr<BoundedArraySizeNode> > size_nodes;
...
TEST_F(SimpleSemanticAnalyzerTest, Subscript) {
  ...
  ExprAnalysis index_expr_analysis(move(index_data_type));
  ...
  ExprAnalysis subscript_expr_analysis(move(subscript_data_type));
  expr_analyzes.insert(
  ...
  IntDataType int_data_type;
  DataType *dest_data_type = &int_data_type;
  DataType *src_data_type = index_data_type_ptr;
  bool is_data_type_convertable = true;
  TestDataTypeConversion test_data_type_conversion =
      {dest_data_type, src_data_type, is_data_type_convertable};
  test_data_type_conversions.push_back(test_data_type_conversion);
...
TEST_F(SimpleSemanticAnalyzerTest,
       SubscriptWithIncompatibleIndexDataTypeIsInvalid) {
  vector< unique_ptr<StmtNode> > stmt_nodes;
  unique_ptr<DataTypeNode> element_data_type_node(new LongDataTypeNode(
      TokenInfo(Token::kLongType, "long", UINT32_C(0), UINT32_C(0))));
  unique_ptr<DataTypeNode> var_data_type_node(new ArrayDataTypeNode(
  ...
  path program_file_path;
  unique_ptr<SemanticProblem> problem(
      new SubscriptWithIncompatibleIndexTypeError(
          program_file_path,
          *subscript_node_ptr,
          int_data_type.Clone(),
