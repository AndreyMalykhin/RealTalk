...
TEST_F(CastResolverTest, ResolveCharAndInt) {
  ...
  DataType *casted_left_data_type = &right_data_type;
  DataType *casted_right_data_type = nullptr;
...
TEST_F(CastResolverTest, ResolveIntAndChar) {
  ...
  DataType *casted_left_data_type = nullptr;
  DataType *casted_right_data_type = &left_data_type;
  bool is_success = true;
  CastResolver::ResolvedCast expected_resolved_cast(
      is_success, casted_left_data_type, casted_right_data_type);
  TestResolve(left_data_type, right_data_type, expected_resolved_cast);
