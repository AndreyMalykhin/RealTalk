...
enum class CmdId: uint8_t {
  ...
  kReturn = UINT8_C(54),
  kReturnIntValue = UINT8_C(55),
  kReturnLongValue = UINT8_C(56),
  kReturnDoubleValue = UINT8_C(57),
  ...
  kLoadLocalIntVarValue = UINT8_C(70),
  kLoadLocalLongVarValue = UINT8_C(71),
  kLoadLocalDoubleVarValue = UINT8_C(72),
  kLoadLocalBoolVarValue = UINT8_C(73),
  kLoadLocalCharVarValue = UINT8_C(74),
  kLoadLocalStringVarValue = UINT8_C(75),
  kLoadLocalArrayVarValue = UINT8_C(76),
  kStoreInt = UINT8_C(77),
  kStoreLong = UINT8_C(78),
  kStoreDouble = UINT8_C(79),
  ...
  kCastCharToDouble = UINT8_C(86),
  kCastCharToString = UINT8_C(87),
  kCastIntToLong = UINT8_C(88),
  kCastIntToDouble = UINT8_C(89),
  kCastLongToDouble = UINT8_C(90)
};
