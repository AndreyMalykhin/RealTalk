...
enum class CmdId: uint8_t {
  ...
  kLoadGlobalIntArrayVarValue,
  kLoadGlobalLongArrayVarValue,
  kLoadGlobalDoubleArrayVarValue,
  kLoadGlobalBoolArrayVarValue,
  kLoadGlobalCharArrayVarValue,
  kLoadGlobalStringArrayVarValue,
