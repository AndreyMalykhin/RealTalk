...
#ifndef _REAL_TALK_PARSER_LESS_OR_EQUAL_NODE_H_
#define _REAL_TALK_PARSER_LESS_OR_EQUAL_NODE_H_
...
class LessOrEqualNode: public BinaryExprNode {
 public:
  LessOrEqualNode(
 ...
 private:
  virtual bool IsEqual(const Node &node) const override {
    return binary_expr_ ==
        static_cast<const LessOrEqualNode&>(node).binary_expr_;
  }
