...
#ifndef _REAL_TALK_PARSER_EQUAL_NODE_H_
#define _REAL_TALK_PARSER_EQUAL_NODE_H_
...
class EqualNode: public ExprNode {
 public:
  EqualNode(
 ...
 private:
  virtual bool IsEqual(const Node &node) const override {
    return binary_expr_ == static_cast<const EqualNode&>(node).binary_expr_;
  }
