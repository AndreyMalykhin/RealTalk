...
#ifndef _REAL_TALK_PARSER_GREATER_NODE_H_
#define _REAL_TALK_PARSER_GREATER_NODE_H_
...
class GreaterNode: public BinaryExprNode {
 public:
  GreaterNode(
 ...
 private:
  virtual bool IsEqual(const Node &node) const override {
    return binary_expr_ == static_cast<const GreaterNode&>(node).binary_expr_;
  }
