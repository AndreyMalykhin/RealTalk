...
#ifndef _REAL_TALK_PARSER_GREATER_OR_EQUAL_NODE_H_
#define _REAL_TALK_PARSER_GREATER_OR_EQUAL_NODE_H_
...
class GreaterOrEqualNode: public BinaryExprNode {
 public:
  GreaterOrEqualNode(
 ...
 private:
  virtual bool IsEqual(const Node &node) const override {
    return binary_expr_ ==
        static_cast<const GreaterOrEqualNode&>(node).binary_expr_;
  }
